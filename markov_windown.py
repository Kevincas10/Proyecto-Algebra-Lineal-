...
class MarkovInterface(QWidget):
    ...
    def initUI(self):
        ...
        self.btn_calcular.setStyleSheet("height: 30px; background-color: #008080; color: white; border: 2px solid black; border-radius: 13px;")
        self.btn_calcular.clicked.connect(self.calcular_markov)

        self.btn_configurar_tablas = QPushButton("Configurar Tablas")
        self.btn_configurar_tablas.setStyleSheet("height: 30px; background-color: #008080; color: white; border: 2px solid black; border-radius: 13px;")
